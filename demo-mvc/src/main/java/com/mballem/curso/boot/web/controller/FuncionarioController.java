...
import com.mballem.curso.boot.web.service.CargoService;
import com.mballem.curso.boot.web.service.FuncionarioService;
...
public class FuncionarioController {
	...
	public String cadastrar(Funcionario funcionario) {
		return "funcionario/cadastro"; //o link/o a pagina em html sem html
	}
	
	@GetMapping("/listar")
	public String listar(ModelMap model) {
		model.addAttribute("funcionarios", funcionarioService.buscarTodos());
		return "funcionario/lista"; //o link/o a pagina em html sem html
	}
